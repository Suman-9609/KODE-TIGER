                    ...
                    <div class="card">
                      <form id="myForm">
                        ...
                        <div class="card__body">
                          ...
                          <div class="form-group mb-4">
                            <input type="number" name="name" id="name" class="form-control" placeholder="Mobile/WhatsApp Number *">
                            <span id="whatsappError" class="badge bg-danger mt-1" style="font-size: 1rem;"></span>
                          </div>
                          <div class="form-group mb-4">
                            <input type="email" name="name" id="name" class="form-control" placeholder="Email Address">
